...
<div class="container-fluid">
    ...
    <div class="page-header">
        ...
        <p>Pengelolaan Data Pelaporan Insiden</p>
    </div>

    <!-- Form Input -->
    <div class="form-card">
        <h5><i class="fa-solid fa-plus-circle me-2"></i>Form Input Pelaporan Insiden</h5>
    ...
    <div class="table-card">
        <h5><i class="fa-solid fa-table me-2"></i>Data Pelaporan Insiden</h5>
