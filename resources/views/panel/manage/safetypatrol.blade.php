...
<div class="container-fluid">
    <div class="page-header">
        ...
        <p>Pengelolaan Data Laporan Safety Patrol</p>
    </div>

    <div class="form-card">
        <h5><i class="fa-solid fa-plus-circle me-2"></i>Form Input Safety Patrol</h5>
    ...
    <div class="table-card">
        <h5><i class="fa-solid fa-table me-2"></i>Data Safety Patrol</h5>
